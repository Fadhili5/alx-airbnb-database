...
SELECT Booking.booking_id, Booking.propery_id, Booking.start_date, Booking.end_date, Booking.total_price, Booking.status, User.user_id, User.last_name, User.email
FROM Booking
